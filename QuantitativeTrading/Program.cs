...
namespace QuantitativeTrading
{
    class Program
    {
        ...
        private const string savePath = @"C:\Users\Kenneth\新北市南山高中\Tang - Quantitative-Backtest - Quantitative-Backtest\CloseChangeAllParams-20200101";
        ...
        static async Task Main(string[] args)
        {
            ...
            DateTime startTime = new(2020, 1, 1);
            ThreeMarketsDatasetModel dataset = await ThreeMarketsDataLoader.LoadCsvDataAsync(Path.Combine(datasetPath, "BTCUSDT-Spot.csv"), Path.Combine(datasetPath, "ETHUSDT-Spot.csv"), Path.Combine(datasetPath, "ETHBTC-Spot.csv"), startTime);
